...
dasel put string -f ~/.mandelbot/config/config.toml -p toml ".rpc.tls_cert_file" "/home/ubuntu/cert/fullchain.pem"
dasel put string -f ~/.mandelbot/config/config.toml -p toml ".rpc.tls_key_file" "/home/ubuntu/cert/privkey.pem"
dasel put bool -f ~/.mandelbot/config/app.toml -p toml ".api.enable" true
dasel put string -f ~/.mandelbot/config/app.toml -p toml ".api.address" "tcp://localhost:1317"
